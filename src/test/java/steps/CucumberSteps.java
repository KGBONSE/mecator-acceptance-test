...
public class CucumberSteps
{
    ...
    String userEmail = firstName.concat("@test.com");

    public CucumberSteps() throws MalformedURLException {
    }
    ...
    public void create_account() throws Throwable {
        ...
        homePage.setEnterEmail(userEmail);
    ...
    @Then("^The dress is added successfully text \"([^\"]*)\"$")
