Feature: Creating account and adding items to chart
  ...
  Scenario Outline: create new account and add item to cart
    ...
    Then The dress is added successfully text "<text>"
    Examples:
      | loginPageTitle   | acccountPageTitle     | dressesPageTitle   | fname | lname | pWord    | text                                             | dayOfBirth | monthOfBirth | yearOfBirth | address   | city   | state | pCode | country       | phone       |
      | Login - My Store | My account - My Store | Dresses - My Store | mark  | kofi  | Curiy7n1 | Product successfully added to your shopping cart | 12         | May          | 1977        | 102 drive | london | Texas | 00000 | United States | 07952983202 |
