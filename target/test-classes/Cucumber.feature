Feature: Creating account and adding items to chart
  ...
  Scenario Outline: create new account and add item to cart
    ...
    Examples:
      | url                                     | emailAddress                 | loginPageTitle   | acccountPageTitle     | dressesPageTitle   | fname | lname | pWord    | text                                             | lastName | dayOfBirth | monthOfBirth | yearOfBirth | address   | city   | state | pCode | country       | phone       |
      | http://automationpractice.com/index.php | l001122yyc25jqc9s7zn6l@test.co.uk | Login - My Store | My account - My Store | Dresses - My Store | mark  | kofi  | Curiy7n1 | Product successfully added to your shopping cart | kofikofi | 12         | May          | 1977        | 102 drive | london | Texas | 00000 | United States | 07952983202 |
